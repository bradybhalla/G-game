...
class State:
    ...
    def create_board(self):
        ...
        self.stones_left = {
                            1: ceil(self.board_size*self.board_size/2),
                            2: floor(self.board_size*self.board_size/2)
                        }
    ...
    def copy(self):
        ...
        state_copy.stones_left = {1:self.stones_left[1], 2:self.stones_left[2]}
    ...
    def play(self, row, col):
        ...
        self.stones_left[self.to_play] -= 1
